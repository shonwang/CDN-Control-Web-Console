        ...
        var SharedSetupView = Backbone.View.extend({
            ...
            onGetChannelSuccess: function() {
                if (this.query !== "all") {
                    ...
                    this.onClickItemDetail(null, model)
                } else {
                    this.initTable();
            ...
            onClickQueryButton: function() {
                ...
                // this.queryArgs.domain = this.$el.find("#input-customer-id").val().trim();
                // if (this.queryArgs.domain == "") this.queryArgs.domain = null;
            ...
            onClickItemDetail: function(event, model) {
                ...
                require(['sharedSetup.detail.view', 'isomorphismManage.detail.model'],
                    function(SharedSetupDetailView, IsomorphismManageDetailModel) {
