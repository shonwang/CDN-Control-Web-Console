    ...
    function(require, exports, template, Modal, Utility) {
        ...
        var SendView = Backbone.View.extend({
            ...
            initialize: function(options) {
                ...
                this.$el = $(_.template(template['tpl/setupTopoManage/setupTopoManage.send.html'])({
                    data: {}
                }));
            ...
            getSendInfoSuccess: function(res) {
                this.table = $(_.template(template['tpl/setupTopoManage/setupTopoManage.send.table.html'])({
