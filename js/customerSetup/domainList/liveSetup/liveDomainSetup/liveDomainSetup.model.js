define("liveDomainSetup.model", ['require','exports', 'utility'], function(require, exports, Utility) {
    var Model = Backbone.Model.extend({
        initialize: function(){}
    });

    var liveDomainSetupCollection = Backbone.Collection.extend({
    ...
    return liveDomainSetupCollection;
});