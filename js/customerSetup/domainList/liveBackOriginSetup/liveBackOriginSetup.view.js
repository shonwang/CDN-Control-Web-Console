define("liveBackOriginSetup.view", ['require','exports', 'template', 'modal.view', 'utility'], function(require, exports, template, Modal, Utility) {

    var LiveBackOriginSetupView = Backbone.View.extend({
        events: {},
