define("backOriginDetection.model", ['require','exports', 'utility'], function(require, exports, Utility) {
    var Model = Backbone.Model.extend({
        initialize: function(){}
    });

    var BackOriginDetectionCollection = Backbone.Collection.extend({
    ...
    return BackOriginDetectionCollection;
});