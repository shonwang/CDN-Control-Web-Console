define("liveBackOriginDetection.model", ['require','exports', 'utility'], function(require, exports, Utility) {
    var Model = Backbone.Model.extend({
        initialize: function(){}
    });

    var LiveBackOriginDetectionCollection = Backbone.Collection.extend({
    ...
    return LiveBackOriginDetectionCollection;
});