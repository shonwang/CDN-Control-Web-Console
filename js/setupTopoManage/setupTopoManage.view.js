define("setupTopoManage.view", ['require', 'exports', 'template', 'modal.view', 'utility'], function (require, exports, template, Modal, Utility) {
    var SendView = Backbone.View.extend({
        ...
        initialize: function (options) {
            ...
            // this.$el.find('.table-ctn .spareradio').on('click', $.proxy(this.onClickRadioButton, this));
...
// debugger
        ...
        initRuleTable: function (data, checked) {
            ...
            if (!this.isEdit) {
                ...
                // this.roleTable.find("tbody .spareradio").on("click", $.proxy(this.onClickItemSpare, this));
            } else {
                this.roleTable.find("tbody .edit").hide();
                this.roleTable.find("tbody .delete").hide();
                // this.roleTable.find("tbody .spareradio").hide();
            }
        },
