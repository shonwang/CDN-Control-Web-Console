define("luaConfigListEdit.model", ['require','exports', 'utility'], function(require, exports, Utility) {
    ...
    var LuaConfigListEditCollection = Backbone.Collection.extend({
    ...
    return LuaConfigListEditCollection;
});