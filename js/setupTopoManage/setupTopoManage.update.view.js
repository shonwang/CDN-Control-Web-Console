        ...
        var UpdateTopoView = Backbone.View.extend({
            ...
            initialize: function(options) {
                ...
                if(this.options.pageType==1){
                    ...
                    this.collection.getSpecialLayerProgress({specialLayerStrategyId:this.model.get('id')});
            ...
            onClickCreateSetupBtn:function(){
                if(this.options.pageType==1)
                   ...
                   this.collection.startSpecialLayerCreateSetup({specialLayerStrategyId:this.model.get("id")})
                else if(this.options.pageType==3)
                   this.collection.startNodeInitSetup({nodeId:this.model.get("id")}) 
