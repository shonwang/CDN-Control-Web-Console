        ...
        getTaskStatistics: function(args) {
            ...
            var url = BASE_URL + "/2018-08-30/realtimelog/task/statistics",
                successCallback = function(res) {
                    if (res) {
                        if (this.param.status200 === true)
                            this.trigger("statistics.chart2.200.success", res);
                        else if (this.param.status200 === false)
                            this.trigger("statistics.chart2.not200.success", res);
                        else if (this.param.status200 === null)
                            this.trigger("statistics.chart1.success", res);
                    } else {
