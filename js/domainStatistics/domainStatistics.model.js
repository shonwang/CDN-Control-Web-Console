define("domainStatistics.model", ['require','exports', 'utility'], function(require, exports, Utility) {
    var Model = Backbone.Model.extend({
        initialize: function(){
        }
    });

    var DomainStatisticsCollection = Backbone.Collection.extend({
    ...
    return DomainStatisticsCollection;
});