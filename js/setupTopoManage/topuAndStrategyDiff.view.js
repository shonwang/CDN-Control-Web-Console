    ...
    function(require, exports, template, Modal, Utility) {
        ...
        var TopuAndStrategyDiffView = Backbone.View.extend({
            ...
            onGetData:function(res){
                var lowerDiffNodes = res && this.getLowerDiffNodes(res.lowerDiffNodes) || [];//下
                var middleDiffNodes = res && this.getMiddleDiffNodes(res.middleDiffNodes) || [];//中
                var upperDiffNodes = res && this.getUpperDiffNodes(res.upperDiffNodes) || [];//上
            ...
            getDiffRules:function(data){
                ...
                for(var i=0;i<data.length;i++){
                    var ruleList = this.getRuleList(data[i].topoRuleChange);
                    var obj = {
                        type:data[i].type,
