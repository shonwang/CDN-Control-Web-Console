define("liveRtmpOptimize.model", ['require','exports', 'utility'], function(require, exports, Utility) {
    var Model = Backbone.Model.extend({
        initialize: function(){}
    });

    var LiveRtmpOptimizeCollection = Backbone.Collection.extend({
    ...
    return LiveRtmpOptimizeCollection;
});