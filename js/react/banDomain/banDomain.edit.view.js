...
define("banDomain.edit.view", ['require', 'exports', 'template', 'base.view', 'utility', "antd", 'react.backbone', "moment"], function (require, exports, template, BaseView, Utility, Antd, React, moment) {
    ...
    var logTaskListEditForm = function (_React$Component) {
        ...
        _createClass(logTaskListEditForm, [{
            ...
            value: function onGetTaskDetailSuccess(res) {
                ...
                }, _defineProperty(_setState, 'senderType', res.taskFieldJson.senderType), _defineProperty(_setState, 'batchCount', res.taskFieldJson.batchCount), _defineProperty(_setState, 'batchInterval', res.taskFieldJson.batchInterval), _defineProperty(_setState, 'logRange', res.taskFieldJson.logRange), _defineProperty(_setState, 'compressMode', res.taskFieldJson.compressMode), _defineProperty(_setState, 'userAgent', res.taskFieldJson.userAgent), _defineProperty(_setState, 'tokenKey', res.taskFieldJson.tokenKey), _defineProperty(_setState, 'taskTokenType', res.taskFieldJson.taskTokenType), _defineProperty(_setState, 'taskTokenTimeType', res.taskFieldJson.taskTokenTimeType), _defineProperty(_setState, 'taskConditionList', res.taskConditionList), _defineProperty(_setState, 'isLoadingTplDetail', false), _setState));
            }
        }, {
            ...
            value: function onGetDomainListSuccess(res) {
                var domainArray = res.map(function (el) {
                    return React.createElement(
                        Option,
                        { key: el },
                        el
