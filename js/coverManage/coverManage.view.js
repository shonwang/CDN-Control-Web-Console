define("coverManage.view", ['require','exports', 'template', 'modal.view', 'utility'], function(require, exports, template, Modal, Utility) {
    var NodeManageView = Backbone.View.extend({
        ...
        onNodeListSuccess: function(res){
            ...
            //             name: '上海联通',
            //             data : [
            //                 [{name:'上海联通'},{name:'乌鲁木齐',value:0}],
            //                 [{name:'上海联通'},{name:'昆明',value:1}],
            //                 [{name:'上海联通'},{name:'广州',value:2}],
            //                 [{name:'上海联通'},{name:'拉萨',value:3}],
            //                 [{name:'上海联通'},{name:'长春',value:4}]
            //             ],
            //             info:{}
            //         },
            //         {
