define("coverManage.view", ['require','exports', 'template', 'modal.view', 'utility'], function(require, exports, template, Modal, Utility) {
    var NodeManageView = Backbone.View.extend({
                ...
                series = [
                    {
                        ...
                        geoCoord: tempDate.geoCoord
                    }
                ],
                allLine = [];

            _.each(tempDate.relation, function(el, key, list){
                ...
                mapTemp.markLine.data = el.data;

                var tempPoints = [];
                _.each(el.data, function(subEl, index, list){
        ...
        render: function(target) {
            ...
            this.collection.trigger("get.node.success");
        }
    });
